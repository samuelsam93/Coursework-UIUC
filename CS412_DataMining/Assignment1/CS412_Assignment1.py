...
# Problem 4
minkh1 = sp.spatial.distance.minkowski(libraries[1][1:-1:1], libraries[2][1:-1:1], p=1)
minkh2 = sp.spatial.distance.minkowski(libraries[1][1:-1:1], libraries[2][1:-1:1], p=2)
minkhinf = sp.spatial.distance.minkowski(libraries[1][1:-1:1], libraries[2][1:-1:1], p=Infinity)
print('a. Minkoski distances')
print('    i. h=1: ', minkh1)
print('    i. h=2: ', minkh2)
print('    i. h=inf: ', minkhinf)

cossim = sp.spatial.distance.cosine(libraries[1][1:-1:1], libraries[2][1:-1:1])
...
pCML = libraries[1][1:-1:1]/np.sum(libraries[1][1:-1:1])
pCBL = libraries[2][1:-1:1]/np.sum(libraries[2][1:-1:1])
